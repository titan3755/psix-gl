...
int main() {
	...
	if (!success) {
		...
		std::cout << "Fragment shader two compiled successfully!" << std::endl;
	}
	...
	if (!success) {
		...
		std::cout << "Shader program two linked successfully!" << std::endl;
	}
	...
	float vertices_two[] = {
		0.69f, 0.5f, 0.0f, // top right
		0.5f, -0.5f, 0.0f, // bottom right
		-0.23f, -0.9f, 0.0f, // bottom left
	};
